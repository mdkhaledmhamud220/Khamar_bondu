...
import { auth, db } from "../../firebaseConfig"; // <--- db ইম্পোর্ট করা হলো
  ...
  const handleRegister = async () => {
    ...
    try {
      ...
      await setDoc(doc(db, "users", cred.user.uid), {
        ...
        phone: phone.trim(),
        role: role, // 'farmer' অথবা 'buyer'
        district: district,
        is_verified: false, // ইমেইল ভেরিফাই করার পর এটি আপডেট করা যাবে
        is_active: true,
        created_at: serverTimestamp(), // ফায়ারবেস সার্ভার টাইমস্ট্যাম্প
      });

      console.log("Firestore-এ ব্যবহারকারীর তথ্য সংরক্ষিত হয়েছে!");
      console.log("hi");
      ...
      const msg =
        err.code === "auth/email-already-in-use"
          ...
          : err.code === "auth/weak-password"
            ? "পাসওয়ার্ড দুর্বল। আরও শক্তিশালী পাসওয়ার্ড দিন।"
        ...
        <View style={styles.card}>
          <>
            ...
            <TouchableOpacity
              style={[
                styles.districtBtn,
                showDistrictPicker && styles.districtBtnActive,
              ]}
            ...
            >
              <Ionicons
                ...
                size={18}
                color={district ? Colors.primary : Colors.textMuted}
              />
              <Text
                style={[
                  styles.districtBtnText,
                  district && styles.districtBtnTextSelected,
                ]}
              >
                    ...
                    >
                      <Text
                        style={[
                          ...
                          district === d && styles.districtItemTextActive,
                        ]}
                      >
                        {d}
                      </Text>
