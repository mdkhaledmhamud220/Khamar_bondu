            ...
            {i < steps.length - 1 && (
              <View
                style={[
                  ...
                  step > s && styles.stepConnectorDone,
                ]}
              />
            )}
          </React.Fragment>
  ...
  return (
    <View style={styles.payBox}>
      ...
      <View style={[styles.payRow, styles.payAdvance]}>
        <View>
          <Text style={[styles.payLabel, { color: Colors.primary }]}>
            অগ্রিম ({advancePercent}%) — এখন পরিশোধ
          </Text>
        ...
        <View style={styles.successBox}>
          ...
          {orderId && (
            <View style={styles.orderIdBox}>
              <Text style={styles.orderIdLabel}>বুকিং কোড</Text>
...
export default function BookingScreen() {
  ...
  useEffect(() => {
    console.log("cow changed =", cow);
  }, [cow]);

  const advance = cow ? Math.round(cow.price * 0.2) : 0;
  ...
  const handleSubmit = async () => {
    ...
    if (!deliveryDate?.trim()) {
      Alert.alert("", "পছন্দের ডেলিভারি তারিখ দিন।");
      return;
    }
    ...
    if (!user) {
      Alert.alert("Login Required", "প্রথমে লগইন করুন।");
      return;
    }

    if (!cow) {
      Alert.alert("ত্রুটি", "গরুর তথ্য পাওয়া যায়নি।");
      return;
    }
    ...
    try {
      ...
      await runTransaction(db, async (transaction) => {
        ...
        if (!cowSnap.exists()) {
          throw new Error("গরুটি পাওয়া যায়নি।");
        }
        ...
        if (cowData.status !== "available") {
          throw new Error("এই গরুটি বর্তমানে বুকিংয়ের জন্য উপলব্ধ নয়।");
        }
      ...
      Alert.alert(
        "Booking Failed",
        error.message || "বুকিং সম্পন্ন করা যায়নি।",
      );
    } finally {
      setSubmitting(false);
    }
          ...
          <>
            ...
            <View style={styles.infoBox}>
              ...
              <Text style={styles.infoText}>
                অগ্রিম পেমেন্ট দিলে গরুটি ৪৮ ঘণ্টার জন্য আপনার জন্য রিজার্ভ
                থাকবে।
              </Text>
            </View>
            ...
            <View style={styles.card}>
              {PAYMENT_METHODS.map((m) => (
                <TouchableOpacity
                  ...
                  style={[
                    styles.pmRow,
                    payMethod === m.key && styles.pmRowActive,
                  ]}
              ...
              {payMethod === "sslcommerz" && (
                <View style={styles.sandboxNote}>
                  <Text style={styles.sandboxText}>
                    ⚠️ Demo mode — টাকা কাটবে না। শুধু test করা যাবে।
                  </Text>
                </View>
              )}
              {payMethod === "cash" && (
                ...
                >
                  <Text style={[styles.sandboxText, { color: Colors.success }]}>
                    ✅ গরু বুঝে নেওয়ার সময় সরাসরি নগদ পরিশোধ করুন।
                  </Text>
                </View>
              )}
            </View>
          ...
          <>
            ...
            <View style={styles.card}>
              ...
              <View style={[styles.reviewRow, styles.reviewHighlight]}>
                <Text style={[styles.reviewLabel, { color: Colors.primary }]}>
                  অগ্রিম পেমেন্ট
                </Text>
                <Text
                  style={[
            ...
            >
              ...
              <Text style={styles.termsText}>
                আমি শর্তাবলীতে সম্মত: বুকিং বাতিল করলে অগ্রিমের ৫০% ফেরত পাবো।
                বিক্রেতা ২৪ ঘণ্টার মধ্যে নিশ্চিত করবেন।
              </Text>
            </TouchableOpacity>
            ...
            <View style={styles.cancellationBox}>
              ...
              <Text style={styles.cancellationText}>
                • বুকিং ২৪ ঘণ্টার আগে বাতিল → ৫০% অগ্রিম ফেরত
              </Text>
              <Text style={styles.cancellationText}>
                • বিক্রেতা বাতিল করলে → সম্পূর্ণ অগ্রিম ফেরত
              </Text>
              <Text style={styles.cancellationText}>
                • গরু পাওয়ার দিন বাকি টাকা পরিশোধ করুন
              </Text>
            </View>
              ...
              {submitting ? (
                ...
                <>
                  ...
                  <Text style={styles.confirmBtnText}>
                    বুকিং নিশ্চিত করুন — {fmt(advance)}
                  </Text>
                </>
              )}
            </TouchableOpacity>
